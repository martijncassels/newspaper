...
import { IErrorReportingService, createStackHelperUnsupportedSourceMapUriError, createStackHelperUnsupportedStackFrameFormat } from '@glimpse/glimpse-common';
...
export class StackHelper implements IStackHelper {
    ...
    public constructor(errorService: IErrorReportingService) {
     ...
     */
    public isGlimpseFrame(frame: IStackFrame): boolean {
    ...
    public parseFrameEntry(source: string): IStackFrame {
        ...
        let openParen, closeParen, colon1, colon2: number;
